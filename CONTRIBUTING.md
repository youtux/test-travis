...
## Issue tracker
test-travis uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [test-travis boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [youtux/test-travis/issues][issues].
...
### Write Documentation
Travis-ci pypi test could always use more documentation, whether as part of the official Travis-ci pypi test docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Travis-ci pypi test` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [youtux/test-travis][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/test-travis.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on test-travis coding standards.
...
[issues]: https://github.com/youtux/test-travis/issues
[repo]: https://github.com/youtux/test-travis
[repo-boards]: https://github.com/youtux/test-travis/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/youtux/test-travis/pull_requests
